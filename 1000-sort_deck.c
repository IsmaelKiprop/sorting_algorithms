 ...
 * @deck: ptr  head of a deck_node_t doubly-linked list.
 */
void insertion_sort_deck_kind(deck_node_t **deck)
{
 ...
 *                             spades diamonds from ace to king.
 * @deck: ptr to the head of  deck_node_t doubly-linked list.
 */
void insertion_sort_deck_value(deck_node_t **deck)
{
	deck_node_t *iter, *insert, *tmp;
 ...
 * @deck: ptr to the head of a deck_node_t doubly-linked list.
 */
void sort_deck(deck_node_t **deck)
{
